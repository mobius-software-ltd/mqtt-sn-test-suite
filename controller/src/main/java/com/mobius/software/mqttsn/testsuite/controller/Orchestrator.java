...
import com.mobius.software.mqttsn.testsuite.common.model.Report;
...
public class Orchestrator
{
	...
	public void start(List<Client> clientList, int totalCommads)
	{
		...
		pendingQueue.addAll(clientList);

		while (scheduleNext())
			;
	}

	public void notifyOnStart(Client startedClient)
	{
		notifyOnComplete(startedClient);
	}
