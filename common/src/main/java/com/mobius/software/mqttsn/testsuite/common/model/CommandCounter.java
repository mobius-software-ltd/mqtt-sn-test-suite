...
public class CommandCounter extends Counter
{
	...
	public CommandCounter(SNType command, Integer count, Direction direction)
	{
	...
	public SNType getCommand()
	{
		return command;
	}

	public void setCommand(SNType command)
	{
		this.command = command;
	}
}
