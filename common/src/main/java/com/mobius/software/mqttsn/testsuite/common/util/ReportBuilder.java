...
import com.mobius.software.mqttsn.testsuite.common.util.table.Cell;
import com.mobius.software.mqttsn.testsuite.common.util.table.TableBuilder;
...
public class ReportBuilder
{
	...
	/*public static String buildError(String identifier, List<ErrorReport> clientErrors)
	{
		...
		builder.addHeader(Cell.center(IDENTIFIER).addValue(4, identifier));
